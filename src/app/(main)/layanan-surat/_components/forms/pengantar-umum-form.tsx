        ...
        <div className="space-y-6 rounded-md border p-4 md:p-6 bg-white shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <FormField control={form.control} name="gender" render={({ field }) => (
              <FormItem><FormLabel>Jenis Kelamin</FormLabel><FormControl><Input placeholder="Laki-Laki / Perempuan" {...field} /></FormControl><FormMessage /></FormItem>
            )} />
            ...
            <FormField control={form.control} name="address" render={({ field }) => (
              <FormItem className="md:col-span-2"><FormLabel>Alamat Lengkap Sesuai KTP</FormLabel><FormControl><Textarea {...field} className="uppercase" /></FormControl><FormMessage /></FormItem>
            )} />
          </div>
        </div>
