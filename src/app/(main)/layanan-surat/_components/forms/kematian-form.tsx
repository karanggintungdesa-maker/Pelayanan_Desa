      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        <FormSection title="Data Jenazah" icon={Skull}>
          ...
          <div className="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6 bg-muted/30 p-4 rounded-lg mt-4">
            ...
            <FormField control={form.control} name="deathCause" render={({ field }) => (
              <FormItem><FormLabel>Sebab Kematian</FormLabel><FormControl><Input placeholder="Contoh: Sakit / Tua" {...field} disabled={isSubmitting} /></FormControl><FormMessage /></FormItem>
            )} />
            <FormField control={form.control} name="whoExplains" render={({ field }) => (
              <FormItem><FormLabel>Yang Menerangkan</FormLabel><FormControl><Input placeholder="Contoh: Dokter / Keluarga" {...field} disabled={isSubmitting} /></FormControl><FormMessage /></FormItem>
            )} />
        ...
        <FormSection title="Data Orang Tua Jenazah">
          ...
          <FormField control={form.control} name="fatherAddress" render={({ field }) => (
            <FormItem className="md:col-span-2"><FormLabel>Alamat</FormLabel><FormControl><Textarea {...field} disabled={isSubmitting} className="uppercase" /></FormControl><FormMessage /></FormItem>
          )} />
        </FormSection>
        ...
        <FormSection title="Pelapor" icon={UserCheck}>
          ...
          <FormField control={form.control} name="reporterGender" render={({ field }) => (
            <FormItem><FormLabel>Jenis Kelamin</FormLabel><FormControl><Input placeholder="Jenis Kelamin" {...field} disabled={isSubmitting} /></FormControl><FormMessage /></FormItem>
          )} />
          <div className="grid grid-cols-2 gap-4">
          ...
          <FormField control={form.control} name="reporterAddress" render={({ field }) => (
            <FormItem className="md:col-span-2"><FormLabel>Alamat Pelapor</FormLabel><FormControl><Textarea {...field} disabled={isSubmitting} className="uppercase" /></FormControl><FormMessage /></FormItem>
          )} />
        </FormSection>
