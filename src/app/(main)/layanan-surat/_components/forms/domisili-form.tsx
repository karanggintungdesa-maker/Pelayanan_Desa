          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="Laki-Laki / Perempuan" {...field} disabled={isSubmitting} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="Agama" {...field} disabled={isSubmitting} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="md:col-span-2">
                ...
                <FormControl>
                  <Textarea placeholder="Alamat tempat tinggal saat ini di Desa Karanggintung" {...field} disabled={isSubmitting} className="uppercase" />
                </FormControl>
