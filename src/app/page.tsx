...
import { ArrowRight, ShieldCheck, Zap, Users, FileCheck, Phone, Mail, MapPin, Facebook, Instagram, Globe } from 'lucide-react';
      ...
      <header className="sticky top-0 z-50 w-full border-b bg-white/80 backdrop-blur-md">
        <div className="container mx-auto px-4 h-20 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <Link href="/profil-desa" className="text-sm font-bold text-slate-600 hover:text-primary">Profil</Link>
        ...
        <div className="container mx-auto px-4 relative z-10 text-white">
          <div className="max-w-3xl space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <Link href="/dashboard">
                <Button size="lg" className="bg-accent hover:bg-yellow-600 text-slate-900 font-black h-14 px-10 text-lg rounded-2xl transition-all active:scale-95">
                  Mulai Layanan Mandiri
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Button>
              </Link>
              <Link href="/profil-desa">
                <Button size="lg" variant="outline" className="bg-white border-white/30 text-slate-900 hover:bg-white/90 font-bold h-14 px-10 text-lg rounded-2xl backdrop-blur-sm transition-all shadow-lg">
                  Kenali Desa Kami
                </Button>
              </Link>
            </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
            {[
              { label: 'Total Penduduk', value: '10.800+', icon: Users, color: 'text-blue-600' },
      ...
      <footer className="bg-slate-950 text-slate-400 py-20 mt-auto border-t border-white/5">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4">
                <Link href="https://www.facebook.com/pages/Desa%20Karanggintung,Gandrungmangu,Cilacap/244086575780042/#" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-accent hover:text-slate-900 transition-all">
                  <Facebook className="h-5 w-5" />
                </Link>
                <Link href="https://www.instagram.com/desa_karanggintung/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-accent hover:text-slate-900 transition-all">
                  <Instagram className="h-5 w-5" />
                </Link>
                <Link href="https://karanggintung-gandrungmangu.desa.id/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-accent hover:text-slate-900 transition-all">
          ...
          <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-[10px] font-bold uppercase tracking-widest">
            ...
            <Link href="https://karanggintung-gandrungmangu.desa.id/" target="_blank" rel="noopener noreferrer" className="hover:text-accent transition-colors">
              Website Resmi Pemerintahan Desa • Transformasi Digital
            </Link>
          </div>
        </div>
      </footer>
